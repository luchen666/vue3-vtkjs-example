...
onMounted(() => {
  ...
  // containerRef.value.appendChild(controlContainer)
  ...
  for (let i = 0; i < 4; i++) {
    ...
    containerRef.value.appendChild(elementParent)
  ...
  // const volumePath = `https://github.com/luchen666/vue3-vtkjs-example/tree/main//data`;
  const volumePath = `https://github.com/Kitware/vtk-js/tree/master/Data/`;
  // const volumePath = `https://gitcode.com/gh_mirrors/vt/vtk-js/tree/master/Data`
  // const volumePath = `/data`;
  reader.setUrl(`${volumePath}/volume/LIDC2.vti`).then(() => {
