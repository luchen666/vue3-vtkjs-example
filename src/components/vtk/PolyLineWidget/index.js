...
import widgetBehavior from '@kitware/vtk.js/Widgets/Widgets3D/PolyLineWidget/behavior';
import stateGenerator from '@kitware/vtk.js/Widgets/Widgets3D/PolyLineWidget/state';
